...
export default function About(
    ...
    const structure = [
        {
            title: getLocalized(about.intro.title),
            display: about.intro.display,
            items: []
        },
        {
            title: getLocalized(about.work?.title),
            display: about.work?.display,
            items: about.work?.experiences?.map((experience: any) => experience.company) || []
        },
        {
            title: getLocalized(about.studies?.title),
            display: about.studies?.display,
            items: about.studies?.institutions?.map((institution: any) => institution.name) || []
        },
        {
            title: getLocalized(about.technical.title),
            display: about.technical.display,
            items: about.technical.skills.map((skill: any) => getLocalized(skill.title))
        },
    ]
    return (
        <Flex
            ...
            <Flex
                ...
                <Flex
                    ...
                    <Flex
                        id={getLocalized(about.intro.title)}
                    ...
                    { about.intro.display && (
                        <Flex
                            ...
                            {getLocalized(about.intro.description)}
                        </Flex>
                    )}
                    ...
                    { about.work?.display && (
                        <>
                            <Heading
                                as="h2"
                                id={getLocalized(about.work.title)}
                                variant="display-strong-s"
                                marginBottom="m">
                                {getLocalized(about.work.title)}
                            </Heading>
                            <Flex
                                direction="column"
                    ...
                    { about.studies?.display && (
                        <>
                            <Heading
                                as="h2"
                                id={getLocalized(about.studies.title)}
                                variant="display-strong-s"
                                marginBottom="m">
                                {getLocalized(about.studies.title)}
                            </Heading>
                            <Flex
                                direction="column"
                                fillWidth gap="l" marginBottom="40">
                    ...
                    { about.technical.display && (
                        <>
                            <Heading
                                as="h2"
                                id={getLocalized(about.technical.title)}
                                variant="display-strong-s" marginBottom="40">
                                {getLocalized(about.technical.title)}
                            </Heading>
                            <Flex
                                direction="column"
                                fillWidth gap="l">
